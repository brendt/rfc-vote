...
<div class="container mx-auto py-7 text-font prose prose-a:text-font hover:prose-a:text-font-second max-w-4xl">
    <h2 class="text-font-second">Shaping PHP, together</h2>
    ...
    <p>For official messages, please consider using the PHP Internals mailing list. Despite common belief, it is in fact, open to anyone.</p>
    ...
    <blockquote class="text-font-second">
        ...
        <div class="text-right">
            <a href="https://externals.io/message/110936#110937" class="text-font-second">Nikita Popov</a>
        </div>
    </blockquote>


    <h2 class="text-font-second">Who's involved?</h2>

    <p>Many people throughout the PHP community have already <a href="https://github.com/brendt/rfc-vote/graphs/contributors" class="text-font-second">contributed to this project</a> — and <a href="https://github.com/brendt/rfc-vote" class="text-font-second">you can too</a>!</p>
    <p>We also want to give a special shout-out to <a href="https://tighten.com/" class="text-font-second">Tighten</a> for helping to create a design.</p>
    <p>The initial idea came from <a href="https://twitter.com/pronskiy" class="text-font-second">Roman Pronskiy</a>, who helps administer the <a href="https://thephp.foundation/" class="text-font-second">PHP Foundation</a>, and is developed (together with many open source enthusiasts) by <a href="https://twitter.com/brendt_gd" class="text-font-second">Brent Roose</a>, developer advocate for PHP at <a href="https://www.jetbrains.com/phpstorm/" class="text-font-second">JetBrains</a>.</p>
    ...
    <h2 class="text-font-second">Interesting links</h2>
