...
<div class="flex items-center justify-center h-screen">
    <div class="
        w-[1200px] h-[627px] bg-purple-500
    ...
    ">
        ...
        <div class="w-[75%]">
            <div class="
                border-purple-600 border-4 flex rounded-full overflow-hidden
                text-white font-bold text-3xl
            ">
                <div
                    class="p-6 py-4 flex-grow text-left border-r-4 border-purple-600 min-w-[15%] bg-green-500"
                    style="width: {{ $rfc->percentage_yes }}%;"
                >
                    {{ $rfc->percentage_yes }}%
                </div>
                <div
                    class="p-6 py-4 flex-grow text-right border-purple-600 min-w-[15%] bg-red-500"
