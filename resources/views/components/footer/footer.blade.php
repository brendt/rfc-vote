<div class="p-8 text-white flex justify-center md:gap-6 gap-4 flex-col bg-main-dark bg-gradient-to-r from-main to-main-dark">
    <div class="flex font-bold flex-wrap md:flex-nowrap gap-4 flex-1 justify-center">
        <span class="w-full md:w-auto">
            This project is open source, you can help out
        </span>
    ...
    <div class="md:text-center">
        <p>
            Special thanks to
            <a
                class="text-purple-200 underline hover:no-underline"
                href="https://github.com/brendt/rfc-vote/graphs/contributors"
            >
                numerous contributors
            </a>
            for sending PRs and helping out!
        </p>
    </div>
