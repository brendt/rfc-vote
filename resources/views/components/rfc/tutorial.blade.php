<x-markdown class="prose text-lg max-w-full dark:text-white">
    ## <span class="dark:text-white">How voting works</span>
...
You can read more about our goals in the <a href="/about" class="dark:text-white">about page</a>.
</x-markdown>
