...
<div id="{{ $anchorLink }}" class="bg-white dark:bg-secondary-dark-mode dark:text-white rounded-xl shadow-md w-full group/card pt-5 pl-4 pr-10 md:px-8 md:pt-7 flex gap-6 items-center relative">
    ...
    <div class="grid gap-2 md:gap-4 w-full">
        ...
        @else
            <x-markdown class="prose dark:text-white prose-md w-full max-w-full break-words overflow-hidden">
                {!! $argument->body !!}
            </x-markdown>
        @endif
