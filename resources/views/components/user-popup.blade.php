...
<span
    class="
        text-xs bg-white p-2 z-10 rounded-xl left-[-50px] bottom-4 font-bold origin-bottom space-x-4 min-w-max shadow-2xl scale-0 duration-300 flex items-center group-hover:scale-100 absolute
    ">
