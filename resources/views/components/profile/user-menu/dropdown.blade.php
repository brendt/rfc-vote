...
<div
    x-show="open"
    x-cloak
    class="absolute dark:bg-secondary-dark-mode dark:text-white dark:divide-secondary-dark-mode bg-white shadow-md text-gray-800 rounded-md top-full mt-3 left-1/2 -translate-x-1/2 w-[170px] divide-y overflow-hidden"
