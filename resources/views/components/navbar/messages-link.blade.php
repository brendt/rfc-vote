...
>
    ...
    @if ($user->unread_message_count > 0)
        <span class="md:absolute ml-1 md:ml-0 -top-1 -right-1 bg-red-500 text-white text-xs rounded-full min-w-[17px] h-[17px] inline-flex items-center justify-center p-0.5">
